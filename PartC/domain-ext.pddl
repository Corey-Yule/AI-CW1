(define (domain lunar-extended)
    ...
    (:action store_sample
        ...
        :precondition (and 
            (rover_pos ?r ?wp)(physical_sample ?r) 
            (not (sample_collected ?l))(lander_rover ?l ?r)(lander_pos ?l ?wp) 
            (deployed_l ?l)(human_pos ?h ?droom)(human_lander ?h ?l)(room_lander ?droom ?l)
        )
    ...
    (:action move_to_docking
        ...
        :precondition (and 
            (human_lander ?h ?l)(room_lander ?from ?l)
            (room_lander ?to ?l)(human_pos ?h ?from)(room_link ?from ?to)
        )
        :effect (and 
            (human_pos ?h ?to)(not (human_pos ?h ?from))
        )
    )
